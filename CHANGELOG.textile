 ...
 * Smoother animations, groups snapping, tab preview is back, fan out feature, lots of refactoring

h4. 0.9.4

 * Fixes the visual artifact when content doesn't fit the icebox at first use
