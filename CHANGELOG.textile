...
h2. Current version: 0.10.x

h3. 0.10.0

 * Add a log viewer
 * Prevent unaccessible tabs from being captured

h2. Versions 0.9.x

h3. 0.9.28

 * Re-enable the tabs thumbnails feature for Chrome 11+
 * Adds some specs coverage with Jasmine
